//
//  CAstarCAsmHeapTest.m
//  CAstar
//
//  Created by Per Olofsson on 2014-04-30.
...
@interface CAstarCAsmHeapTest : XCTestCase

@property CASCAsmHeap *heap;
@property NSArray *testNumbers;
@property NSArray *sortedNumbers;

@end

@implementation CAstarCAsmHeapTest

- (void)setUp
{
    [super setUp];
    self.heap = [[CASCAsmHeap alloc] init];
